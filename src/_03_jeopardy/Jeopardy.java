...
public class Jeopardy implements ActionListener {
	...
	private JButton createButton(String dollarAmount) {
		...
		JButton newestButton = new JButton(dollarAmount);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// Increase the score by the prizeMoney and Pop up a message to tell the user they were correct
		if(answer.equalsIgnoreCase(correctAnswer)) {
			score+= prizeMoney;
			showCorrectImage();
		}
		// Otherwise
		// Decrement the score by the prizeMoney and Pop up a message to tell the user they were wrong and give them the correct answer
		else {
			score-= prizeMoney;
			showIncorrectImage();
		}
